...
const About = () => {
  ...
  const latestAbout = aboutData[aboutData.length - 1];

  return (
    <section
      className="bg-[#fafbfc] py-16 md:py-28 px-4 sm:px-6 lg:px-8 overflow-hidden"
      style={{
        backgroundImage:
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="relative mb-8 md:mb-10">
            ...
            <motion.div className="relative w-40 h-40 md:w-64 md:h-64 rounded-full p-1.5 bg-gradient-to-tr from-black to-violet-500 shadow-2xl">

              <div className="w-full h-full rounded-full border-[6px] border-white overflow-hidden bg-white">

                <img
                  src={`https://sagar-korde-portfolio.onrender.com/uploads/${latestAbout?.image}`}
                  alt="Sagar Korde"
          ...
          <motion.div
            variants={fadeInUp}
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-700 text-xs font-bold uppercase tracking-widest mb-4"
          >
            <Rocket size={14} /> Full Stack Engineer
          </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {aboutData.map((item, index) => (
                <motion.div
                  ...
                  variants={fadeInUp}
                  whileHover={{ y: -10 }}
                  className="group bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all"
                >

                  <div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center text-blue-600 mb-5">
                    <Lightbulb size={20} />
                  </div>
          ...
          >
            ...
            <div className="lg:sticky md:mt-10 lg:top-28 space-y-6">
              ...
              <div className="bg-slate-900 md:mb-32 rounded-[2.5rem] p-8 shadow-2xl">
              ...
              <div className="bg-white rounded-[2.5rem] border border-slate-100 p-8 shadow-xl flex items-center gap-7">
